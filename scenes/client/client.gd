...
## Add the "Loading" scene to _this_ scnene.
...
## Removes the "Loading" scene from _this_ scnene.
...
## Adds the "Main Menu" scene to _this_ scnene.
...
## Removes the "Main Menu" scene from _this_ scnene.
